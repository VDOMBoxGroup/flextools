package net.vdombox.ide.core.model
{
	...
	public class LocalesProxy extends Proxy implements IProxy
	{
		...
		private static const LOCALES : XML = <locales><locale code="en_US" description="English"/><locale code="ru_RU" description="Русский"/><locale code="fr_FR" description="French"/></locales>
