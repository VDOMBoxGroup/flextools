...
//			contextMenu.addItem( delItem );
		...
		private function delItemSelectHandler( event : Event ) : void
		{
			...
			Alert.Show( resourceManager.getString( "DataBase_General", "delete_table" ), resourceManager.getString( "DataBase_General", "delete_Renderer" ), AlertButton.OK_No, parentApplication, closeHandler );
