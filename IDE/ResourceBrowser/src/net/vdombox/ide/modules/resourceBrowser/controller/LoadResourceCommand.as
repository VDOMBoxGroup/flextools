package net.vdombox.ide.modules.resourceBrowser.controller
{
	...
	public class LoadResourceCommand extends SimpleCommand
	{
		...
		private function completeHandler( event : Event ) : void
		{
			...
			{
				sendNotification( Notifications.LOADED_RESOURCES_BY_LOADING, { totalProgtess: { loading: countTotalResources - pendingFiles.length, total: countTotalResources }, resourceStatus: "Convert to base64" } );
