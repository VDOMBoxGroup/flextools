package net.vdombox.ide.modules.resourceBrowser.view
{
	...
	public class ResourcesAreaMediator extends Mediator implements IMediator
	{
		...
		private function deleteResourceHandler( event : ListItemEvent ) : void
		{
			...
			Alert.Show( ResourceManager.getInstance().getString( 'ResourceBrowser_General', 'delete_Resource' ), ResourceManager.getInstance().getString( 'ResourceBrowser_General', 'delete_Renderer' ) + "\n" + componentName + " ?", AlertButton.OK_No, resourcesArea, deleteResourceCloseHandler );
