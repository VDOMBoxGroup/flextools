package net.vdombox.ide.common.view.components.resize
{
	...
	public class ResizeManager extends EventDispatcher
	{
		...
		/**
		 * Returns true if the resizing should be constrained to keep the resizeComponent from going outside the parent
		 * bounds.
		 */
