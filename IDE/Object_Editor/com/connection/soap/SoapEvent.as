package com.connection.soap
{
	...
	public class SoapEvent extends EventDispatcher
	{
		...
		public static var GET_TYPE_RESOURSE_OK 			:String = "Get type resource OK"; 		//8
		public static var GET_APPLICATION_RESOURSE_OK 	:String = "Get application resource OK" 	//9
		public static var RENDER_WYSIWIDG_OK 			:String = "Render wysiwyg OK"; 			//10
		...
		public static var GET_CHILD_OBJECT_OK 			:String = "String Get child objects OK"; 		//13
		public static var GET_APPLICATION_LANGUAGE_DATE_OK :String = "Get application language data OK"; //14
		...
		public static var SET_RESURSE_OK 				:String = "Set resource OK"; 			//18
		...
		public static var GET_TYPE_RESOURSE_ERROR 			:String = "Get type resource ERROR"; 		//8
		public static var GET_APPLICATION_RESOURSE_ERROR 	:String = "Get application resource ERROR" 	//9
		public static var RENDER_WYSIWIDG_ERROR 			:String = "Render wysiwyg ERROR"; 			//10
		...
		public static var GET_CHILD_OBJECT_ERROR 			:String = "String Get child objects ERROR"; 		//13
		public static var GET_APPLICATION_LANGUAGE_DATE_ERROR :String = "Get application language data ERROR"; //14
		...
		public static var SET_RESURSE_ERROR 				:String = "Set resource ERROR"; 			//18
