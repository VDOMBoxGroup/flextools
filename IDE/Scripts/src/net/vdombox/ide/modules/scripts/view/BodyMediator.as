package net.vdombox.ide.modules.scripts.view
{
	...
	public class BodyMediator extends Mediator implements IMediator
	{
		...
		{
			sendNotification( Notifications.SAVE_PARAMETERS_TABS, { librariesBox: body.librariesBox.width, actionsBox: body.actionsBox.width, containersPanel: body.containersPanel.height / body.actionsBox.height, globalScriptsPanel: body.globalScriptsPanel.height / body.actionsBox.height } );
		}
