			...
			switch ( name )
			{
				...
				case Notifications.SCRIPT_CHECKED:
				{
					...
					/*
					   ...
					   Alert.Show(	"Server action 'Maks' has been modified on the server and is in the conflict with your
					   changes.\nDo you want to load from server or save your modification?", AlertButton.OK_No_Cancel,
					   workArea.parentApplication, saveActionRequest );
					   }
					 */
