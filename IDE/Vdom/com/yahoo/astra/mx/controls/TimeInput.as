...
package com.yahoo.astra.mx.controls
{
	...
	//--------------------------------------
		...
		override protected function commitProperties():void
		{
			...
			var AMPMField:UITextField = UITextField(this.textFields[3]);
			AMPMField.type = TextFieldType.DYNAMIC;
		...
		override protected function measure():void
		{
			...
			for each(var separatorField:UITextField in this.separators)
			{
				this.measuredWidth += separatorField.measuredWidth;
			}
		...
		/**
		 * @copy com.yahoo.astra.mx.controls.inputClasses.BaseMultiFieldInput#focusNextTextField()
		 */
