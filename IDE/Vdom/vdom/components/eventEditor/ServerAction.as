package vdom.components.eventEditor 
{
	...
	public class ServerAction extends Canvas
	{
...
//				setValue(data);
		...
		private function changeState(blHide:Boolean):void
		{
			...
			}else
			{
				...
				txt.text = txt.text = "ServerAction";//resourceManager.getString('Event','action');
			}	
...
//	 		startDrag();
	  ...
	  private function stopDragHandler(msEvt:MouseEvent):void
	 {
		...
		private function initUpBody():void
		{
			...
			txt.text = "ServerAction";//resourceManager.getString('Event','action');
...
//			trace('return: '+min.toString());
		...
		private var _parametrs:String;
		public function get parametrs():XML
		{
			return XML('<![CDATA[' +_parametrs + ']'+']>');
		}
