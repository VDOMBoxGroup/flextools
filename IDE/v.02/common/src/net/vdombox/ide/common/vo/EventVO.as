package net.vdombox.ide.common.vo
{
	...
	{
		public function EventVO( typeID : String, eventDescription : XML )
		{
			_typeID = typeID;

			_name = eventDescription.@Name[ 0 ];
			_help = eventDescription.@Help[ 0 ];

			var parametersXML : XML = eventDescription.Parameters[ 0 ];
			...
			if ( parametersXML )
			{
				...
				{
					_parameters.push( new EventParameterVO( _typeID, parameterXML ) );
				}
			}
		}
