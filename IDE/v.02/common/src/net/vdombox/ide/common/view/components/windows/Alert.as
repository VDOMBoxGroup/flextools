package net.vdombox.ide.common.view.components.windows
{
	...
	public class Alert extends Window
	{
		...
		public static function Show( title : String = "", label : String = "", buttonView : uint = 0x0256, parent : Object = null, closeHandler : Function = null ) : net.vdombox.ide.common.view.components.windows.Alert
		{
			if ( !parent )
				return null;
