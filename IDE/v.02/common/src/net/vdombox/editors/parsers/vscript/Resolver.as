package net.vdombox.editors.parsers.vscript
{
	...
	public class Resolver
	{
		...
		public function getAllOptions( pos : int, hashLibraries : HashLibraryArray ) : Vector.<String>
		{
			...
			var a : Vector.<String> = new <String>["Integer", "String", "Double", "Boolean", "Binary", "Array", "Date", "Dictionary", "Empty", "Error", "Generic", "Mismatch", "Nothing", "Null", "Mod", "Is", "As", "IsNot", "False", "True", "Not", "And", "Xor", "Or", "Dim", "ReDim", "Preserve", "Const", "Sub", "Exit", "End", "this", "Function", "If", "Then", "Else", "ElseIf", "Select", "Case", "Do", "Loop", "While", "Until", "Wend", "For", "Next", "To", "Step", "Each", "In", "New", "Print", "Set"];
