package net.vdombox.editors.parsers.vscript
{
	...
	public class VScriptWordsStorage
	{
		...
		private static var _vscriptWordsString : Vector.<String> = new <String>["And", "AndAlso", "application", "Array", "As", "AsJSON", "Binary", "Boolean", "ByVal", "ByRef", "Case", "Catch", "Chr", "Class", "Connection", "Const", "cstr", "Date", "Dictionary", "Dim", "Do", "Double", "Each", "Else", "ElseIf", "Empty", "End", "Eqv", "Erase", "Error", "Exit", "False", "Finally", "For", "Function", "Generic", "Get", "Hex", "If", "In", "inherits", "Integer", "Imp", "Is", "IsFalse", "IsNot", "IsTrue", "Let", "Like", "Loop", "Match", "Matches", "Mid", "Mismatch", "Mod", "New", "Next", "Not", "Nothing", "Null", "Oct", "Or", "OrElse", "Preserve", "Print", "Proxy", "Randomize", "ReDim", "RegExp", "request", "Rem", "replace", "response", "Select", "server", "Session", "Set", "Sgn", "Step", "String", "Sub", "Then", "this", "To", "ToJSON", "True", "Try", "UBound", "Until", "Use", "VdomDbConnection", "VDOMDBRecordSet", "VDOMDBRow", "VDOMImaging", "Wend", "While", "WHOLEConnection", "WHOLEError", "WHOLEConnectionError", "WHOLENoConnectionError", "WHOLERemoteCallError", "WHOLEIncorrectResponse", "WHOLENoAPIError", "WHOLENoApplication", "With", "XMLAttribute", "XMLDocument", "XMLDomstirngSizeError", "XMLElement", "XMLError", "XMLHierarchyRequestError", "XMLIndexSizeError", "XMLInuseAttributeError", "XMLInvalidAccessError", "XMLInvalidCharacterError", "XMLInvalidModificationError", "XMLInvalidStateError", "XMLNamespaceError", "XMLNoDataAllowedError", "XMLNotFoundError", "XMLNotSupportedError", "XMLNode", "XMLSyntaxError", "XMLWrongDocumentError", "Xor"  ];
		...
		private static function init() : void
		{
			...
			_vscriptWords.setValue( "Hex", 					new AutoCompleteItemVO( VDOMImage.Standard, "Hex", "", "" ) );
			...
			_vscriptWords.setValue( "Oct", 					new AutoCompleteItemVO( VDOMImage.Standard, "Oct", "", "" ) );
			...
			_vscriptWords.setValue( "Sgn", 					new AutoCompleteItemVO( VDOMImage.Standard, "Sgn", "", "" ) );
