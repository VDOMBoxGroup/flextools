package net.vdombox.ide.modules.scripts.view.components
{
	...
	public class PreferencesWindow extends Window
	{
		...
		{
			dispatchEvent( new PopUpWindowEvent( PopUpWindowEvent.APPLY, null, "", { colorScheme: colorSchemes.selectedItem, fontSize: int( fontSize.selectedItem.toString() ), autoShowAutoComplete: autocompleteAutoShow.selected, selectKeyByAutoComplte: selectKeyByAutoComplte, showIndentLines: showIndentLinesBox.selected } ) );
		}
