package net.vdombox.ide.modules.wysiwyg.model.business
{
	...
	public class VdomDragProxy extends UIComponent
	{
		...
		public function VdomDragProxy( dragInitiator : IUIComponent, dragSource : DragSource )
		{
			...
			var sm : ISystemManager = dragInitiator.systemManager.topLevelSystemManager;

			sm.addEventListener( MouseEvent.MOUSE_MOVE, mouseMoveHandler, true );

			sm.addEventListener( MouseEvent.MOUSE_UP, mouseUpHandler, true );
		}
		...
		public function mouseMoveHandler( event : MouseEvent ) : void
		{
			...
			if ( _target )
			{
				...
				var oldTarget : IUIComponent = _target;
		...
		public function mouseUpHandler( event : MouseEvent ) : void
		{
			...
			sm.removeEventListener( MouseEvent.MOUSE_MOVE, mouseMoveHandler, true );

			// in case we go offscreen
			stage.removeEventListener( MouseEvent.MOUSE_MOVE, stage_mouseMoveHandler );

			sm.removeEventListener( MouseEvent.MOUSE_UP, mouseUpHandler, true );

			// in case we go offscreen
			stage.removeEventListener( Event.MOUSE_LEAVE, mouseLeaveHandler );

			if ( _target && action != DragManager.NONE )
			{
