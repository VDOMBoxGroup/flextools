...
package com.yahoo.astra.mx.controls.colorPickerClasses
{
	...
	//--------------------------------------
		...
		/**
		 * @copy com.yahoo.astra.mx.controls.colorPickerClasses.IColorPreviewViewer#showPreview
		 */
		...
		/**
		 * @copy com.yahoo.astra.mx.controls.colorPickerClasses.IColorPreviewViewer#previewColor
		 */
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			if(this.showPreview)
			{
				...
				if(angle <= 45)
				{
					...
					var position:Point = PointUtil.polarToXY(radians, length);
				...
				else
				{
					...
					position = PointUtil.polarToXY(radians, length);
