...
public class AutoCompleteManager extends EventDispatcher
{
     ...
     */
    protected function getDropdown(textInput:TextInput):ListBase
    {
			...
			if(_currentCollection !=null)
			{
	            ...
	            else 
	            {
	 				...
	 				if(autoFillEnabled && !_removeSelection)
					{
						...
						var lbl:String = _currentCollection.getItemAt(0) as String;
	            	...
	            	if(popUpEnabled)
	            	{
		                ...
		                { 
				                ...
				                point.y > dropdown.height)
				            {
				                ...
				                point.y -= (textInput.height + dropdown.height + 
    ...
    protected function keyDownHandler(event:KeyboardEvent):void
    {
        ...
        else
        {
                ...
                event.keyCode == Keyboard.PAGE_DOWN)
            {
            	...
            	//not popped up, so pop it up on down arrow
            	else
            	{
