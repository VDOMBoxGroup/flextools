...
//			_contentToolbar.close();
		...
		private function resizeManager_resizeCompleteHandler( event : ResizeManagerEvent ) : void
		{
			...
			if ( changeFlag && IItem( currentObject ).editableAttributes[ 0 ] && currentToolBar && !currentToolBar.selfChanged )
			{
...
//		callLater( scrollToObject, [ _objectId ] );
			...
			if ( selectedObject && IItem( selectedObject ).editableAttributes[ 0 ] && currentToolBar && !currentToolBar.selfChanged )
			{
