...
//define the WSDLOperation: new WSDLOperation(methodName)
		...
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_echo" );
		get_echo.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "create_guid" );
		create_guid.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "delete_object" );
		delete_object.inputMessage = requestMessage;
		...
		var update_object : WSDLOperation = new WSDLOperation( "update_object" );
		//input message for the operation
		requestMessage = new WSDLMessage( "update_object" );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "sid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "skey" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "appid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "objid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		...
		requestMessage.encoding.useStyle = "literal";
		requestMessage.isWrapped = true;
		requestMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "update_object" );

		responseMessage = new WSDLMessage( "update_objectResponse" );
		responseMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "Result" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		responseMessage.encoding = new WSDLEncoding();
		responseMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		responseMessage.encoding.useStyle = "literal";
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "update_object" );
		update_object.inputMessage = requestMessage;
		update_object.outputMessage = responseMessage;
		update_object.schemaManager = this.schemaMgr;
		update_object.soapAction = "http://services.vdom.net/VDOMServices/update_object";
		update_object.style = "document";
		BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.addOperation( update_object );//define the WSDLOperation: new WSDLOperation(methodName)
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "whole_delete" );
		whole_delete.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "search" );
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "keep_alive" );
		keep_alive.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "close_session" );
		close_session.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "open_session" );
		open_session.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_type" );
		get_type.inputMessage = requestMessage;
		...
		var set_server_actions : WSDLOperation = new WSDLOperation( "set_server_actions" );
		//input message for the operation
		requestMessage = new WSDLMessage( "set_server_actions" );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "sid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "skey" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "appid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "objid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "actions" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.encoding = new WSDLEncoding();
		requestMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		requestMessage.encoding.useStyle = "literal";
		requestMessage.isWrapped = true;
		requestMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_server_actions" );

		responseMessage = new WSDLMessage( "set_server_actionsResponse" );
		responseMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "Result" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		responseMessage.encoding = new WSDLEncoding();
		responseMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		responseMessage.encoding.useStyle = "literal";
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_server_actions" );
		set_server_actions.inputMessage = requestMessage;
		set_server_actions.outputMessage = responseMessage;
		set_server_actions.schemaManager = this.schemaMgr;
		set_server_actions.soapAction = "http://services.vdom.net/VDOMServices/set_server_actions";
		set_server_actions.style = "document";
		BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.addOperation( set_server_actions );//define the WSDLOperation: new WSDLOperation(methodName)
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "send_event" );
		send_event.inputMessage = requestMessage;
		...
		var create_objects : WSDLOperation = new WSDLOperation( "create_objects" );
		//input message for the operation
		requestMessage = new WSDLMessage( "create_objects" );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "sid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "skey" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "appid" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		...
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "objects" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.encoding = new WSDLEncoding();
		requestMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		requestMessage.encoding.useStyle = "literal";
		requestMessage.isWrapped = true;
		requestMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "create_objects" );

		responseMessage = new WSDLMessage( "create_objectsResponse" );
		responseMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "Result" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		responseMessage.encoding = new WSDLEncoding();
		responseMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		responseMessage.encoding.useStyle = "literal";
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "create_objects" );
		create_objects.inputMessage = requestMessage;
		create_objects.outputMessage = responseMessage;
		create_objects.schemaManager = this.schemaMgr;
		create_objects.soapAction = "http://services.vdom.net/VDOMServices/create_objects";
		create_objects.style = "document";
		BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.addOperation( create_objects );//define the WSDLOperation: new WSDLOperation(methodName)
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_application_info" );
		set_application_info.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "list_applications" );
		list_applications.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "export_application" );
		export_application.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "execute_sql" );
		execute_sql.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "create_application" );
		create_application.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "submit_object_script_presentation" );
		submit_object_script_presentation.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "whole_create" );
		whole_create.inputMessage = requestMessage;
		...
		requestMessage.addPart( new WSDLMessagePart( new QName( "http://services.vdom.net/VDOMServices", "session_id" ), null, new QName( "http://www.w3.org/2001/XMLSchema", "string" ) ) );
		requestMessage.encoding = new WSDLEncoding();
		requestMessage.encoding.namespaceURI = "http://services.vdom.net/VDOMServices";
		requestMessage.encoding.useStyle = "literal";
		requestMessage.isWrapped = true;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "remote_method_call" );
		remote_method_call.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_application_structure" );
		get_application_structure.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_thumbnail" );
		get_thumbnail.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_application_language_data" );
		get_application_language_data.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_application_structure" );
		set_application_structure.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_one_object" );
		get_one_object.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_name" );
		set_name.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "whole_create_page" );
		whole_create_page.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "list_types" );
		list_types.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "create_object" );
		create_object.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "render_wysiwyg" );
		render_wysiwyg.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_attributes" );
		set_attributes.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_script" );
		set_script.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_application_info" );
		get_application_info.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_script" );
		get_script.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_child_objects_tree" );
		get_child_objects_tree.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "modify_resource" );
		modify_resource.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_child_objects" );
		get_child_objects.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_resource" );
		get_resource.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_code_interface_data" );
		get_code_interface_data.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_application_events" );
		get_application_events.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "about" );
		about.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_resource" );
		set_resource.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_application_events" );
		set_application_events.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "list_resources" );
		list_resources.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_all_types" );
		get_all_types.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "set_attribute" );
		set_attribute.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "whole_update" );
		whole_update.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_object_script_presentation" );
		get_object_script_presentation.inputMessage = requestMessage;
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "install_application" );
		install_application.inputMessage = requestMessage;
		...
		BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.addOperation( install_application );//define the WSDLOperation: new WSDLOperation(methodName)
		...
		responseMessage.isWrapped = true;
		responseMessage.wrappedQName = new QName( "http://services.vdom.net/VDOMServices", "get_top_objects" );
		get_top_objects.inputMessage = requestMessage;
		...
		BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.addOperation( get_top_objects );
	}
	 ...
	 * @return Asynchronous token
	 */
	public function update_object( sid : String, skey : String, appid : String, objid : String, data : String ) : AsyncToken
	{
		var headerArray : Array = new Array();
		var out : Object = new Object();
		out["sid"] = sid;
		...
		out["objid"] = objid;
		out["data"] = data;
		currentOperation = BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.getOperation( "update_object" );
		var pc : PendingCall = new PendingCall( out, headerArray );
		call( currentOperation, out, pc.token, pc.headers );
		return pc.token;
	}
	 ...
	 * Performs the low level call to the server for the operation
	 * It passes along the headers and the operation arguments
	 * @param sid* @param skey* @param appid* @param objid* @param actions
	 * @return Asynchronous token
	 */
	public function set_server_actions( sid : String, skey : String, appid : String, objid : String, actions : String ) : AsyncToken
	{
		var headerArray : Array = new Array();
		var out : Object = new Object();
		out["sid"] = sid;
		...
		out["objid"] = objid;
		out["actions"] = actions;
		currentOperation = BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.getOperation( "set_server_actions" );
		var pc : PendingCall = new PendingCall( out, headerArray );
		call( currentOperation, out, pc.token, pc.headers );
		return pc.token;
	}
	 ...
	 * Performs the low level call to the server for the operation
	 * It passes along the headers and the operation arguments
	 * @param sid* @param skey* @param appid* @param parentid* @param objects
	 * @return Asynchronous token
	 */
	public function create_objects( sid : String, skey : String, appid : String, parentid : String, objects : String ) : AsyncToken
	{
		var headerArray : Array = new Array();
		var out : Object = new Object();
		out["sid"] = sid;
		...
		out["objects"] = objects;
		currentOperation = BaseVdomService.getPort( "BaseVdomPort" ).binding.portType.getOperation( "create_objects" );
		var pc : PendingCall = new PendingCall( out, headerArray );
		call( currentOperation, out, pc.token, pc.headers );
		return pc.token;
	}
	 ...
	 * Performs the low level call to the server for the operation
	 * It passes along the headers and the operation arguments
	 * @param sid* @param skey* @param appid* @param objid* @param func_name* @param xml_param* @param session_id
	 * @return Asynchronous token
	 */
	public function remote_method_call( sid : String, skey : String, appid : String, objid : String, func_name : String, xml_param : String, session_id : String ) : AsyncToken
	{
		var headerArray : Array = new Array();
		var out : Object = new Object();
		out["sid"] = sid;
