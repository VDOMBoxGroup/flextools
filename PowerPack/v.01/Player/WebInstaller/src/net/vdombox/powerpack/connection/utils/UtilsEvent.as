package net.vdombox.powerpack.connection.utils
{
...
public class UtilsEvent extends Event
{
	...
	public function UtilsEvent( type : String, source : Object = null, base64data : String = '', bubbles : Boolean = false, cancelable : Boolean = true )
	{
