...
{
	import src.net.vdombox.powerpack.lib.extendedapi.containers.SuperTabNavigator;
	import src.net.vdombox.powerpack.lib.extendedapi.controls.tabBarClasses.SuperTab;
	import src.net.vdombox.powerpack.lib.extendedapi.controls.tabBarClasses.SuperUIComponent;
	 ...
	 */
	[Event(name="tabUpdated", type="src.net.vdombox.powerpack.lib.extendedapi.events.SuperTabEvent")]
