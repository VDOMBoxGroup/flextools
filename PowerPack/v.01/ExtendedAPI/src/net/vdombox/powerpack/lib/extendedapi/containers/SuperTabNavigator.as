...
{
	import src.net.vdombox.powerpack.lib.extendedapi.controls.SuperTabBar;
	import src.net.vdombox.powerpack.lib.extendedapi.controls.tabBarClasses.SuperTab;
	import src.net.vdombox.powerpack.lib.extendedapi.events.SuperTabEvent;
	import src.net.vdombox.powerpack.lib.extendedapi.events.TabReorderEvent;
	 ...
	 */
	[Event(name="tabClose", type="src.net.vdombox.powerpack.lib.extendedapi.events.SuperTabEvent")]
	
	[Event(name="tabsReordered", type="src.net.vdombox.powerpack.lib.extendedapi.events.TabReorderEvent")]
	...
	public class SuperTabNavigator extends TabNavigator
	{
		...
		public static var styleInitialized:Boolean = initializeStyles();
	    ...
	    */
	    ...
	    //--------------------------------------------------------------------------
	    //
	    //  Overridden methods: TabNavigator
	    //
	    //--------------------------------------------------------------------------
		...
		override protected function createChildren():void
	    {
	        ...
	        if(!popupButton) {
	        	...
	        	popupButton.addEventListener(MouseEvent.MOUSE_OVER, popupButtonOver);
	        }	        
	    ...
	    */
	    ...
	    public function getSuperTabBar():SuperTabBar
	    {
	    ...
	    */
	    public function reorderTabList():void {
	   	...
	   	public function clone():SuperTabNavigator
	   	{
	   		var newTabNav:SuperTabNavigator = new SuperTabNavigator();
	   		
	   		newTabNav.popUpButtonPolicy = this.popUpButtonPolicy;
	   		newTabNav.allowTabSqueezing = this.allowTabSqueezing;
	   		newTabNav.minTabWidth = this.minTabWidth;
	   		newTabNav.styleName = this.styleName;

	   		newTabNav.closePolicy = this.closePolicy;
	   		newTabNav.dragEnabled = this.dragEnabled;
	   		newTabNav.dropEnabled = this.dropEnabled;
	   		newTabNav.editableTabLabels = this.editableTabLabels;

	   		newTabNav.startScrollingEvent = this.startScrollingEvent;
	   		newTabNav.stopScrollingEvent = this.stopScrollingEvent;
	   		newTabNav.scrollSpeed = this.scrollSpeed;
	    ...
	    public function removeEmptyContainers():void
	    {
	        if(numChildren>0 || !parent)
	        	return;
	        
	       	var obj:DisplayObjectContainer = this;
			while(obj.parent && (obj.parent is DividedBox) && obj.parent.parent && obj.parent.numChildren==1) {
    			obj = obj.parent;
			}	
	    ...
	    */
	    ...
	    //--------------------------------------------------------------------------
	    //
	    //  Overridden event handlers: TabNavigator
	    //
	    //--------------------------------------------------------------------------	    
	    ...
	    private function tabsReordered(event:TabReorderEvent):void {
	    	...
	    	if(sourceBar != tabBar) {
	    		...
	    		if(sourceBar.numChildren==0)
	    		{
	    			var sourceNav:Object = sourceBar;
	    ...
	    */
	    ...
	    private function popupButtonOver(event:Event):void {
	    	callLater(reorderTabList);
	    }
