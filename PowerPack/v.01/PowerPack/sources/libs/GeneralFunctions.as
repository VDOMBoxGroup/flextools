 ...
 */	
function _sub(graph:Object, ...args):void
{
 ...
 */		 
function _subPrefix(graph:Object, prefix:Object, ...args):void
{
...
function _enterSubgraph(subgraph:GraphStruct, prefix:String, params:Array=null):void
{
 ...
 */		 
function _question(question:String, answers:String):Function
{
 ...
 */		 
function _convert(type:String, value:Object):void
{
	var result:String;
 ...
 */		
function _writeTo(filename:String):void
{			
...
function _imageToBase64(pic:Bitmap, type:String=null):String
{
 ...
 */		
function _writeVarTo(filename:String, value:Object):void
{
 ...
 */		
function _loadDataFrom(filename:String):void
{	
	try 
	{		
 ...
 */		 
function _mid(start:int, length:int, string:String):String
{
 ...
 */		 
function _replace(string:String, tgt:String, flags:String, src:String):String
{
 ...
 */		 
function _split(delimiter:String, string:String):String
{
 ...
 */		 
function _random(value:int):String 
{
