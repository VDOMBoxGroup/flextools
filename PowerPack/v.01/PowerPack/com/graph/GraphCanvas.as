package PowerPack.com.graph
{
	...
	public class GraphCanvas extends Canvas
	{
	    ...
	    //
	    //--------------------------------------------------------------------------
	    private static var alertClearTitle:String = "Confirmation";
	    private static var alertClearText:String = "Are you sure want to clear stage?";
	    ...
	    public static function set langXML(value:XML):void
	    {
			...
			alertClearTitle = _langXML.graphcanvas.alertcleartitle;
			alertClearText = _langXML.graphcanvas.alertcleartext;

        	menuItemCaptions = [];
        	
	    	menuItemCaptions = new Array(
	    		_langXML.graphcanvas.menuitemadd, 
	    		_langXML.graphcanvas.menuitempaste, 
    			_langXML.graphcanvas.menuitemclear );		   
	        	        
	        Application.application.dispatchEvent(new Event("canvasLanguageChanged"));
	    }
		...
		public function GraphCanvas()
		{
			...
			Application.application.addEventListener("canvasLanguageChanged", languageChangeHandler);
		...
		{		
			...
			{	
	  		...
	  		Application.application.removeEventListener("canvasLanguageChanged", languageChangeHandler);
		...
		{			
     		if(parent)
     		{
	     		Alert.show(alertClearText, alertClearTitle, Alert.YES|Alert.NO, this, alertRemoveHandler, null, Alert.NO);			     	
	     	}
		}		
