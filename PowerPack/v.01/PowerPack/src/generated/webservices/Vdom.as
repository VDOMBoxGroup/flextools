...
/**
 * Dispatches when a call to the operation update_object completes with success
 * and returns some data
 * @eventType Update_objectResultEvent
 */
[Event(name="Update_object_result", type="generated.webservices.Update_objectResultEvent")]
...
/**
 * Dispatches when a call to the operation set_server_actions completes with success
 * and returns some data
 * @eventType Set_server_actionsResultEvent
 */
[Event(name="Set_server_actions_result", type="generated.webservices.Set_server_actionsResultEvent")]
...
/**
 * Dispatches when a call to the operation create_objects completes with success
 * and returns some data
 * @eventType Create_objectsResultEvent
 */
[Event(name="Create_objects_result", type="generated.webservices.Create_objectsResultEvent")]
...
public class Vdom extends EventDispatcher implements IVdom
{
	...
	/**
	 * @see IVdom#update_object()
	 */
	public function update_object( sid : String, skey : String, appid : String, objid : String, data : String ) : AsyncToken
	{
		var _internal_token : AsyncToken = _baseService.update_object( sid, skey, appid, objid, data );
		_internal_token.addEventListener( "result", _update_object_populate_results );
		_internal_token.addEventListener( "fault", throwFault );
		return _internal_token;
	}

	/**
	 * @see IVdom#update_object_send()
	 */
	public function update_object_send() : AsyncToken
	{
		return update_object( _update_object_request.sid, _update_object_request.skey, _update_object_request.appid, _update_object_request.objid, _update_object_request.data );
	}
	 ...
	 * @private
	 */
	private var _update_object_request : Update_object_request;

	/**
	 * @see IVdom#update_object_request_var
	 */
	[Bindable]
	public function get update_object_request_var() : Update_object_request
	{
		return _update_object_request;
	}

	/**
	 * @private
	 */
	public function set update_object_request_var( request : Update_object_request ) : void
	{
		_update_object_request = request;
	}
	 ...
	 * @private
	 */
	private var _update_object_lastResult : String;
	[Bindable]
	/**
	 * @see IVdom#update_object_lastResult
	 */
	public function get update_object_lastResult() : String
	{
		return _update_object_lastResult;
	}

	/**
	 * @private
	 */
	public function set update_object_lastResult( lastResult : String ) : void
	{
		_update_object_lastResult = lastResult;
	}

	/**
	 * @see IVdom#addupdate_object()
	 */
	public function addupdate_objectEventListener( listener : Function ) : void
	{
		addEventListener( Update_objectResultEvent.Update_object_RESULT, listener );
	}

	/**
	 * @private
	 */
	private function _update_object_populate_results( event : ResultEvent ) : void
	{
		var e : Update_objectResultEvent = new Update_objectResultEvent();
		e.result = event.result as String;
		e.headers = event.headers;
		update_object_lastResult = e.result;
		dispatchEvent( e );
	...
	/**
	 * @see IVdom#set_server_actions()
	 */
	public function set_server_actions( sid : String, skey : String, appid : String, objid : String, actions : String ) : AsyncToken
	{
		var _internal_token : AsyncToken = _baseService.set_server_actions( sid, skey, appid, objid, actions );
		_internal_token.addEventListener( "result", _set_server_actions_populate_results );
		_internal_token.addEventListener( "fault", throwFault );
		return _internal_token;
	}

	/**
	 * @see IVdom#set_server_actions_send()
	 */
	public function set_server_actions_send() : AsyncToken
	{
		return set_server_actions( _set_server_actions_request.sid, _set_server_actions_request.skey, _set_server_actions_request.appid, _set_server_actions_request.objid, _set_server_actions_request.actions );
	}
	 ...
	 * @private
	 */
	private var _set_server_actions_request : Set_server_actions_request;

	/**
	 * @see IVdom#set_server_actions_request_var
	 */
	[Bindable]
	public function get set_server_actions_request_var() : Set_server_actions_request
	{
		return _set_server_actions_request;
	}

	/**
	 * @private
	 */
	public function set set_server_actions_request_var( request : Set_server_actions_request ) : void
	{
		_set_server_actions_request = request;
	}
	 ...
	 * @private
	 */
	private var _set_server_actions_lastResult : String;
	[Bindable]
	/**
	 * @see IVdom#set_server_actions_lastResult
	 */
	public function get set_server_actions_lastResult() : String
	{
		return _set_server_actions_lastResult;
	}

	/**
	 * @private
	 */
	public function set set_server_actions_lastResult( lastResult : String ) : void
	{
		_set_server_actions_lastResult = lastResult;
	}

	/**
	 * @see IVdom#addset_server_actions()
	 */
	public function addset_server_actionsEventListener( listener : Function ) : void
	{
		addEventListener( Set_server_actionsResultEvent.Set_server_actions_RESULT, listener );
	}

	/**
	 * @private
	 */
	private function _set_server_actions_populate_results( event : ResultEvent ) : void
	{
		var e : Set_server_actionsResultEvent = new Set_server_actionsResultEvent();
		e.result = event.result as String;
		e.headers = event.headers;
		set_server_actions_lastResult = e.result;
		dispatchEvent( e );
	...
	/**
	 * @see IVdom#create_objects()
	 */
	public function create_objects( sid : String, skey : String, appid : String, parentid : String, objects : String ) : AsyncToken
	{
		var _internal_token : AsyncToken = _baseService.create_objects( sid, skey, appid, parentid, objects );
		_internal_token.addEventListener( "result", _create_objects_populate_results );
		_internal_token.addEventListener( "fault", throwFault );
		return _internal_token;
	}

	/**
	 * @see IVdom#create_objects_send()
	 */
	public function create_objects_send() : AsyncToken
	{
		return create_objects( _create_objects_request.sid, _create_objects_request.skey, _create_objects_request.appid, _create_objects_request.parentid, _create_objects_request.objects );
	}
	 ...
	 * @private
	 */
	private var _create_objects_request : Create_objects_request;

	/**
	 * @see IVdom#create_objects_request_var
	 */
	[Bindable]
	public function get create_objects_request_var() : Create_objects_request
	{
		return _create_objects_request;
	}

	/**
	 * @private
	 */
	public function set create_objects_request_var( request : Create_objects_request ) : void
	{
		_create_objects_request = request;
	}
	 ...
	 * @private
	 */
	private var _create_objects_lastResult : String;
	[Bindable]
	/**
	 * @see IVdom#create_objects_lastResult
	 */
	public function get create_objects_lastResult() : String
	{
		return _create_objects_lastResult;
	}

	/**
	 * @private
	 */
	public function set create_objects_lastResult( lastResult : String ) : void
	{
		_create_objects_lastResult = lastResult;
	}

	/**
	 * @see IVdom#addcreate_objects()
	 */
	public function addcreate_objectsEventListener( listener : Function ) : void
	{
		addEventListener( Create_objectsResultEvent.Create_objects_RESULT, listener );
	}

	/**
	 * @private
	 */
	private function _create_objects_populate_results( event : ResultEvent ) : void
	{
		var e : Create_objectsResultEvent = new Create_objectsResultEvent();
		e.result = event.result as String;
		e.headers = event.headers;
		create_objects_lastResult = e.result;
		dispatchEvent( e );
	...
	{
		var _internal_token : AsyncToken = _baseService.remote_method_call( sid, skey, appid, objid, func_name, xml_param, session_id );
	...
	{
		return remote_method_call( _remote_method_call_request.sid, _remote_method_call_request.skey, _remote_method_call_request.appid, _remote_method_call_request.objid, _remote_method_call_request.func_name, _remote_method_call_request.xml_param, _remote_method_call_request.session_id );
	}
