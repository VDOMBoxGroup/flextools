	...
	*/
    ...
    public function set breakpoint(value:Boolean):void
    {
    	if(_breakpoint != value)
    	{
	        ...
	        dispatchEvent(new Event("breakpointChanged"));
	    }
    }
	...
	{			
		...
		removeEventListener("typeChanged" , typeChangedHandler);
    ...
    override protected function createChildren():void
    {
        ...
        if (ContextManager.FLASH_CONTEXT_MENU && !contextMenu)
        {
        	...
        	contextMenu.addItem(new SuperNativeMenuItem('check', LanguageManager.sentences['node_breakpoint'], 'breakpoint', category==NodeCategory.COMMAND));
