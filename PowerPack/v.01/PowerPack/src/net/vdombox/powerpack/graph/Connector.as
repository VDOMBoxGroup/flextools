...
public class Connector extends UIComponent implements IFocusManagerComponent
{
	...
	private function drawArrows() : void
	{
		...
		if ( _highlighted )
		{
			focusColor = getStyle( "focusHighlightColor" );
		}
		else if ( _over )
		{
			focusColor = getStyle( "focusRollOverColor" );
		}
		else if ( focused )
		{
			focusColor = getStyle( "focusSelectionColor" );
		}
		...
		if ( !_enabled )
		{
			color = getStyle( "disabledColor" );
		}
		else if ( _highlighted )
		{
			color = getStyle( "highlightColor" );
		}
		else if ( _over )
		{
