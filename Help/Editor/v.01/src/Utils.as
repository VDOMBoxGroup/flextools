package
{
	...
	public class Utils
	{
		...
		public static const TYPE_WIDTH		: Number = 0;
		public static const TYPE_HEIGHT		: Number = 1;
		...
		public static function getSizeFromStyle(strStyle:String, type:Number) : Number
		{
			...
			var strWidthInZeroIndex		: String = "width";
			
			var strHeight				: String = " height";
			var strHeightInZeroIndex	: String = "height";
			...
			var str : String = type == TYPE_WIDTH ? strWidth : strHeight;
			var strInZeroIndex : String = type == TYPE_WIDTH ? strWidthInZeroIndex : strHeightInZeroIndex;
			
			firstInd = strStyle.search(str);
			
			if (firstInd == -1) 
			{
				firstInd = strStyle.search(strInZeroIndex); // we need to get 0
				if (firstInd > 0)
					firstInd = -1;
			}
		...
		public static function clearASCII(value : String) : String
		{
			var regExpControlCodes : RegExp = /(\x00|\x01|\x02|\x03|\x04|\x05|\x06|\x07|\x0b|\x0c|\x0e|\x0f|\x10|\x11|\x12|\x13|\x14|\x15|\x16|\x17|\x18|\x19|\x1a|\x1b|\x1c|\x1d|\x1e|\x1f)/g;
