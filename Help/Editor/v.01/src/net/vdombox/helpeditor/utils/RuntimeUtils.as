package net.vdombox.helpeditor.utils
{
	public class RuntimeUtils
	{
		...
		public static const RUN_TIME_ERRORS : Object = {  "1000":"The system is out of memory.", 
		...
		private static var regExpError : RegExp = /Error #\d{4}/;
		private static var regExpErrorCode : RegExp = /\d{4}/;
		
		public function RuntimeUtils()
		{
		}
		
		public static function isRuntimeError (msg : String) : Boolean
		{
			if (msg.length != 11 || !regExpError.test(msg))
				return false;
			
			var errorCode : Number = Number(msg.match(regExpErrorCode)[0]);
			
			if (!RUN_TIME_ERRORS[errorCode])
				return false;
				
			return true;
		}
		
		public static function getRuntimeErrorMessage (msg : String) : String
		{
			var errorCode : Number = Number(msg.match(regExpErrorCode)[0]);
